...
<html>
   ...
   <body>
         ...
         <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
               <ul class="navbar-nav mr-auto">
				  ...
				  <li class="nav-item ">
                     <a class="nav-link" href="../modificaciones/">Modificaciones <span class="sr-only">(seleccionado)</span></a>
                  </li>
               </ul>
            </div>
         </nav>
	  ...
	  <?php echo $message; ?>
         <h1 class="mt-5">Modificaciones de usuarios</h1>
         <p class="lead">Ingrese el dato pedido para comenzar la modificación de un usuario.</p>
		 
      	 <form action="modificar.php" method="post" class="form-signin">
